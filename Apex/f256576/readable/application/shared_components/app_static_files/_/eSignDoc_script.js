...
//values based showing
// const dataContainer = document.querySelector('.set-values');
// const dataContainer = document.getElementById('set-values');

// if (dataContainer) {
//   const editToggle = dataContainer.dataset.editToggle;
//   const docSign = dataContainer.dataset.docSign;

//   const editToggle = parseFloat(configEl?.dataset?.editToggle || '0');
//   const docSign = parseFloat(configEl?.dataset?.docSign || '0');
